...
def setJoyAndBtd(valueX, valueY,brake):
    scale=16000
    xPos = int(valueX*scale)
    yPos = int(valueY*scale)
    joystickPosition = vj.generateJoystickPosition(wAxisX = 16000+xPos, wAxisY = 16000+yPos,lButtons = brake)
    # vj.sendButtons(brake)
    vj.update(joystickPosition)
